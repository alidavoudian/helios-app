...
#ifndef HELIOS_PART_WATDIC_WORKLOAD_H
#define HELIOS_PART_WATDIC_WORKLOAD_H
...
class Watdic_workload_T
{
public:
    Watdic_workload_T(std::string str_fp,std::vector<int> vec_patt,int workload_nbr,std::vector<int> pattern_fq):
...
void Watdic_workload_T::sort_vec_pattern()
{
    std::sort(vec_pattern.begin(),vec_pattern.end(),std::less<int>());
}
int Watdic_workload_T::set_replace_triple_pattern_file_path()
{
...
int Watdic_workload_T::set_replace_triple_pattern()
{
    for (int i = 0; i < vec_str_file_path.size(); ++i) {
...
int Watdic_workload_T::set_query_head(Query &p,int pattern_index, int k)
{
...
int Watdic_workload_T::set_query_body(Query &p, int pattern_index, int k)
{
...
template <class T>
    int Watdic_workload_T::set_query(T &QB)
    {
...
template <class T>
int Watdic_workload_T::add_query_to_QB(T & QB, int pattern_index)
{
