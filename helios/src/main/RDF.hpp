...
class LUBM_queryBank {
	...
	public:
		/////////////////////////////
		LUBM_queryBank(): qList(_LUBM_query_nbr_, Query()) {
...
class WATDiv_queryBank {
	...
	public:
		/////////////////////////////
		WATDiv_queryBank(): qList(_WATDiv_query_nbr_, Query()) {
...
public:
	/////////////////////////////
	LUBM_queryBank2(): qList(_LUBM_query_nbr_, Query()) {
		...
		RDFterm t1(Type::Variable, "X"),
				...
				t8(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#subOrganizationOf>"), 
				t9(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#University>"), 
				t10(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#Department>"),
				t11(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#memberOf>"),
				t12(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#GraduateStudent>"),
				t13(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#undergraduateDegreeFrom>"),
				t14(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#name>"),
				t15(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#Course>"), 
				t16(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#UndergraduateStudent>"),
				t17(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#worksFor>"),
				t18(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#FullProfessor>"),
				t19(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#emailAddress>"),
				t20(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#telephone>"),
				t21(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#ResearchGroup>"),
				t22(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#teacherOf>"),
				t23(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#advisor>"), 
				t24(Type::URI, "<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#takesCourse>"),

				t25(Type::URI, "<http://www.-Department0.University0.edu>"),
				t26(Type::URI, "<http-://www.University0.edu> ");
		...
		RDFtermList l8;
		l8.add(t8);//subOrganizationOf
		
		RDFtermList l9;
		l9.add(t9);//University
		
		RDFtermList l10;
		l10.add(t10);//Department
		
		RDFtermList l11;
		l11.add(t11);//memberOf
		
		RDFtermList l12;
		l12.add(t12); //GraduateStudent

		RDFtermList l13;
		l13.add(t13); //undergraduateDegreeFrom		
		
		RDFtermList l14;
		l14.add(t14);//ub:name

		RDFtermList l15;
		l15.add(t15);//ub:Course


		RDFtermList l16;
		l16.add(t16);//ub:UndergraduateStudent

		RDFtermList l17;
		l17.add(t17);//ub:worksFor

		RDFtermList l18;
		l18.add(t18);//FullProfessor

		RDFtermList l19;
		l19.add(t19);//emailAddress

		RDFtermList l20;
		l20.add(t20);//telephone

		RDFtermList l21;
		l21.add(t21);//ResearchGroup

		RDFtermList l22;
		l22.add(t22);//teacherOf

		RDFtermList l23;
		l23.add(t23);//advisor

		RDFtermList l24;
		l24.add(t24);//takesCourse

		RDFtermList l25;
		l25.add(t25);//http-://www.Department0.University0.edu

		RDFtermList l26;
		l26.add(t26);//<http-://www.University0.edu> 
		
		triplePattern p1(l6, l8, l2),
					  p2(l2,l7,l9),
					  p3(l6,l7,l10),
					  p4(l1,l11,l6),
					  p5(l1,l7,l12),
		...
		//-------------------------------query1
		qList[0].addToHead(t1);
		qList[0].addToHead(t2);
		qList[0].addToHead(t6);
		qList[0].addToBody(p1);
		qList[0].addToBody(p2);
		qList[0].addToBody(p3);
		qList[0].addToBody(p4);
		qList[0].addToBody(p5);
		qList[0].addToBody(p6);
		
		//-------------------------------query2
		qList[1].addToHead(t1);
		qList[1].addToBody(p7);
		qList[1].addToBody(p8);
		...
		qList[2].addToBody(p9);
		qList[2].addToBody(p10);
		qList[2].addToBody(p11);
		qList[2].addToBody(p12);
		qList[2].addToBody(p13);
		qList[2].addToBody(p14);

		
		//-------------------------------query4
		qList[3].addToHead(t1);
		qList[3].addToBody(p15);
		qList[3].addToBody(p16);
		qList[3].addToBody(p17);
		qList[3].addToBody(p18);
		qList[3].addToBody(p19);

		//-------------------------------query5
		qList[4].addToHead(t1);
		qList[4].addToBody(p20);
		qList[4].addToBody(p21);
		
		//-------------------------------//query6
		qList[5].addToHead(t1);
		qList[5].addToHead(t2);
		qList[5].addToBody(p22);
		qList[5].addToBody(p23);
		qList[5].addToBody(p24);
		qList[5].addToBody(p25);

		
		//-------------------------------//query7
		qList[6].addToHead(t1);
		qList[6].addToHead(t2);
		qList[6].addToHead(t6);
		qList[6].addToBody(p26);
		qList[6].addToBody(p27);
		qList[6].addToBody(p28);
		qList[6].addToBody(p29);
		qList[6].addToBody(p30);
		qList[6].addToBody(p31);
...
//////////YAGO2_queryBank
class YAGO2_queryBank{
private:
	/////////////////////////////
	vector<Query> qList;
public:
	/////////////////////////////
	YAGO2_queryBank(): qList(_LUBM_query_nbr_, Query()) {
...
//////////YAGO2_queryBank_2
class YAGO2_queryBank_2{
private:
	/////////////////////////////
	vector<Query> qList;
public:
	/////////////////////////////
	YAGO2_queryBank_2(): qList(_LUBM_query_nbr_, Query()) {
		
		RDFterm t1(Type::Variable, "p"),
				t2(Type::Variable, "p1"),
				t3(Type::Variable, "p2"),
				t4(Type::Variable, "a"),
				t5(Type::Variable, "a1"),
				t6(Type::Variable, "a2"),
				t7(Type::Variable, "name1"),
				t8(Type::Variable, "name2"),
				t9(Type::Variable, "GivenName"),
				t10(Type::Variable, "FamilyName"),
				t11(Type::Variable, "city"),
				t12(Type::Variable, "moive"),
				
				
				t13(Type::URI, "<http://yago-knowledge.org/resource/#hasGivenName>"), 
				t14(Type::URI, "<http://yago-knowledge.org/resource/#hasFamilyName>"), 
				t15(Type::URI, "<http://yago-knowledge.org/resource/#wasBornIn>"), 
				t16(Type::URI, "<http://yago-knowledge.org/resource/#hasAcademicAdvisor>"), 
				t17(Type::URI, "<http://yago-knowledge.org/resource/#isMarriedTo>"), 
				t18(Type::URI, "<http://yago-knowledge.org/resource/#hasPreferredName>"), 
				t19(Type::URI, "<http://yago-knowledge.org/resource/#actedIn>");
		...
		l9.add(t9);//GivenName		
		RDFtermList l10;
		l10.add(t10);//FamilyName		
		RDFtermList l11;
		l11.add(t11);//city		
		RDFtermList l12;
		l12.add(t12);//moive		
		RDFtermList l13;
		l13.add(t13);//hasGivenName		
		RDFtermList l14;
		l14.add(t14);//hasFamilyName		
		RDFtermList l15;
		l15.add(t15);//wasBornIn		
		RDFtermList l16;
		l16.add(t16);//hasAcademicAdvisor		
		RDFtermList l17;
		l17.add(t17);//isMarriedTo		
		RDFtermList l18;
		l18.add(t18);//hasPreferredName		
		RDFtermList l19;
		l19.add(t19);//actedIn		
		triplePattern p1(l1, l13, l9), 	//q1	?p y: hasGivenName ? GivenName
					  p2(l1,l14,l10),   //q1	?p y: hasFamilyName ? FamilyName 
					  p3(l1,l15,l11),   //q1	?p y: wasBornIn ? city
					  p4(l1,l16,l4),    //q1	?p y: hasAcademicAdvisor ?a
					  p5(l4,l15,l11),	//q1	?a y: wasBornIn ? city
					  
					  p6(l1,l13,l9),	//q2	?p y: hasGivenName ? GivenName .
					  p7(l1,l14,l10),	//q2	?p y: hasFamilyName ? FamilyName
					  p8(l1,l15,l11),	//q2	?p y: wasBornIn ? city
					  p9(l1,l16,l4),	//q2	?p y: hasAcademicAdvisor ?a
					  p10(l4,l15,l11),	//q2	?a y: wasBornIn ? city .
					  p11(l1,l17,l3),	//q2	?p y: isMarriedTo ?p2 .	
					  p12(l3,l15,l11),	//q2	?p2 y: wasBornIn ? city .
					  
					  p13(l5,l18,l7),	//q3	?a1 y: hasPreferredName ? name1
					  p14(l6,l18,l8),	//q3	?a2 y: hasPreferredName ? name2
					  p15(l5,l19,l12),	//q3	?a1 y: actedIn ? movie 	
					  p16(l6,l19,l12),	//q3	?a2 y: actedIn ? movie .
					  
					  p17(l2,l18,l7),	//q4	?p1 y: hasPreferredName ? name1
					  p18(l3,l18,l8),	//q4	?p2 y: hasPreferredName ? name2 .
					  p19(l2,l17,l3),	//q4	?p1 y: isMarriedTo ?p2 .
					  p20(l2,l15,l11),	//q4	?p1 y: wasBornIn ? city 
					  p21(l2,l15,l11);	//q4	?p1 y: wasBornIn ? city 
		
		//-------------------------------query1
		qList[0].addToHead(t9);
		qList[0].addToHead(t10);
		qList[0].addToBody(p1);
		qList[0].addToBody(p2);
		qList[0].addToBody(p3);
		qList[0].addToBody(p4);
		...
		//-------------------------------query2
		qList[1].addToHead(t9);
		qList[1].addToHead(t10);

		qList[1].addToBody(p6);
		qList[1].addToBody(p7);
		qList[1].addToBody(p8);
		qList[1].addToBody(p9);
		qList[1].addToBody(p10);
		qList[1].addToBody(p11);
		qList[1].addToBody(p12);
		
		
		//-------------------------------query3
		qList[2].addToHead(t7);
		qList[2].addToHead(t8);


		qList[2].addToBody(p13);
		qList[2].addToBody(p14);
		qList[2].addToBody(p15);
		qList[2].addToBody(p16);
		
		//-------------------------------	query4
		
		qList[3].addToHead(t7);
		qList[3].addToHead(t8);
		
		qList[3].addToBody(p17);
		qList[3].addToBody(p18);
		qList[3].addToBody(p19);
		qList[3].addToBody(p20);
		qList[3].addToBody(p21);
